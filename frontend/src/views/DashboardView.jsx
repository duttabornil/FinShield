...
function MetricCard({ label, value, meta, tone = 'primary', icon: Icon }) {
  return (
    <article className="fs-card fs-metric-card">
      ...
      <div className="fs-metric-foot">Synthetic demo telemetry</div>
    </article>
  );
}
  ...
  return (
    <div className="fs-page">
      <section className="fs-page-head">
        <div>
          <div className="fs-title-row"><h1>Ecosystem Overview</h1><span className="fs-demo-pill"><span/> SYNTHETIC DATASET // SIMULATED STREAM</span></div>
          <p>Real-time telemetry, risk distribution and threat triage for the FinShield prototype.</p>
        </div>
      ...
      <section className="fs-system-banner">
        ...
        <div className="fs-system-copy"><strong>FINSHIELD DEFENSE PIPELINE ACTIVE</strong><span>Behavioral scoring + graph analysis + explainable alerts are running on synthetic data.</span></div>
        <div className="fs-system-note"><CheckCircle2 size={14}/> DEMO-SAFE / NO REAL CUSTOMER DATA</div>
      </section>
